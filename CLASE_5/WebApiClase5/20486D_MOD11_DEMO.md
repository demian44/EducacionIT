...
1. Abrir 01_IdentityExample_begin\IdentityExample**, and then from the address bar, copy the address.

2. In the **IdentityExample - Microsoft Visual Studio** window, on the **DEBUG** menu, click **Start Without Debugging**.
